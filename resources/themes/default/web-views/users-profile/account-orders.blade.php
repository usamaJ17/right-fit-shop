    ...
    <div class="container py-4 rtl">
        <div class="row">
            ...
            <section class="col-lg-9 __customer-profile">
                ...
                <div class="card __card d-none d-lg-flex web-direction">
                    <div class="card-body">
                        @if($orders->count()>0)
                ...
                <div class="d-flex border rounded p-2 justify-content-between gap-2">
                    <div class="">
                        <div class="media-order">
                            <a href="{{ route('account-order-details', ['id'=>$order->id]) }}" class="d-block position-relative">
                                @if($order->seller_is == 'seller')
                                    <img class="border" alt="{{ translate('shop') }}"
                                         src="{{ getValidImage(path: 'storage/app/public/shop/'.(isset($order->seller->shop) ? $order->seller->shop->image:'shop'), type: 'shop') }}">
                                @elseif($order->seller_is == 'admin')
                                    <img alt="{{ translate('shop') }}"
                                        src="{{ getValidImage(path: 'storage/app/public/company/'.$web_config['fav_icon']->value, type: 'logo') }}">
                            ...
                            <div class="cont text-start">
                                ...
                                <div class="d-flex flex-column gap-1 fs-12">
                                    ...
                                    <div class="d-flex gap-2 align-items-center">
                                        ...
                                        <div class="text-dark font-weight-bold">{{ webCurrencyConverter(amount: $order['order_amount']) }}</div>
                                    </div>
                                    <div>
                                        @if($order['order_status']=='failed' || $order['order_status']=='canceled')
                                            <span class="badge badge-danger text-capitalize">
