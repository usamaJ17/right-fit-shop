...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/back-end/css/installation.css') }}">
</head>
...
<script src={{ asset("public/assets/back-end/js/jquery.js") }}></script>
...
<script src="{{ asset('public/assets/back-end/js/installation.js') }}"></script>
{!! Toastr::message() !!}
</html>
