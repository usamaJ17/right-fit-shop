                    ...
                    <div class="card-body text-start">
                        ...
                        <div class="mt-2">
                            <div class="flex-start">
                                ...
                                <div class="mx-1"><h4>{{$details?->deliveryMan?->bank_name ?? translate('no_data_found')}}</h4></div>
                            </div>
                            <div class="flex-start">
                                <div><h6 class="text-nowrap">{{translate('branch')}} : </h6></div>
                                <div class="mx-1"><h6>{{$details?->deliveryMan?->branch ?? translate('no_data_found') }}</h6></div>
                            </div>
                            <div class="flex-start">
                                <div><h6 class="text-nowrap">{{translate('holder_name')}} : </h6></div>
                                <div class="mx-1"><h6>{{$details?->deliveryMan?->holder_name ?? translate('no_data_found') }}</h6></div>
                            </div>
                            <div class="flex-start">
                                <div><h6 class="text-nowrap">{{translate('account_no')}} : </h6></div>
                                <div class="mx-1"><h6>{{$details?->deliveryMan?->account_no ??  translate('no_data_found') }}</h6></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{route('vendor.delivery-man.withdraw.update-status',[$details['id']])}}" method="POST">
                            @csrf
