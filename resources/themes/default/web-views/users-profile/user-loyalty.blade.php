...
@section('content')
                        ...
                        <div class="d-flex justify-content-end mb-2 mb-sm-0 d-sm-none">
                            <div class="position-relative">
                                <button type="button"
                                    ...
                                    <img src="{{asset('public/assets/front-end/img/icons/icon-i.png')}}" alt=""
                                         width="18">
                                </button>
                            ...
                            <div class="col-md-6">
                                <div class="card btn--primary h-100 position-relative">
                                    ...
                                    <img class="wallet-card-bg z-1"
                                         src="{{ asset('public/assets/front-end/img/reward-card.png') }}" alt="">
                                </div>
                            </div>
                                    ...
                                    <div class="mt-3 text-center d-none d-sm-block">
                                        @if ($walletStatus == 1 && $loyaltyPointStatus == 1)
                                            <button type="button" class="btn btn-sm rounded btn--primary"
                                                    data-toggle="modal" data-target="#convertToCurrency">
                                            <span>
                    ...
                    <div class="card-body pt-0">
                                ...
                                <div class="bg--light my-1 p-3 p-sm-3 rounded d-flex justify-content-between g-2">
                                    <div class="">
                                        <h6 class="mb-2 d-flex align-items-center gap-8">
                                            @if($item['debit'] != 0)
                                                <img
                                                    src="{{ asset('public/assets/front-end/img/icons/coin-danger.png') }}"
                                                    width="25" alt="">
                                            @else
                                                <img
                                                    src="{{ asset('public/assets/front-end/img/icons/coin-success.png') }}"
                                                    width="25" alt="">
                                            @endif
                        ...
                        @if($loyaltyPointList->count()==0)
                            <div class="d-flex flex-column gap-3 align-items-center text-center my-5">
                                <img width="72"
                                     src="{{ asset('public/assets/front-end/img/icons/empty-transaction-history.png')}}"
    ...
    <div class="bottom-sticky4 bg-white d-md-none p-3">
        @if ($walletStatus == 1 && $loyaltyPointStatus == 1)
            <button type="button" class="btn rounded btn--primary w-100" data-toggle="modal"
...
@push('script')
    <script src="{{ asset('public/assets/front-end/js/user-loyalty.js') }}"></script>
@endpush
